...
private:
	...
	size_t num_node_toAllCore = 0;
	size_t num_node_toDense = 0;
#endif
private:
	...
	//state transitions
	inline void PointTransite_toCore(size_t point);
	inline void NodeTransite_incNumCore(KDTreeHere* node);
	inline bool checkAllcore(KDTreeHere* node);
	inline bool checkAllcore(KDTreeHere* node, bool force);
	inline void NodeTransite_toAllcore(KDTreeHere* node);
	inline bool checkOnecluster(KDTreeHere* node);
	inline bool checkOnecluster(KDTreeHere* node, bool force);
	inline void NodeTransite_toDense(KDTreeHere* node);
	inline void NodeTransite_toDense(KDTreeHere* queryNode, KDTreeHere* node);
